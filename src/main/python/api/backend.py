...
# This can make the code more readable and help with debugging.
#
...
def init(raw_data=None):
    ...
    # In the following case a very long statement has been split up into multiple lines.
    # It is easily recognizable what values are passed into the function.
    # If I wanted to change or exclude on value temporarily (for example for debugging)
