...
#
# Cheat Sheet point 9:
# Make a comment if the code is not intuitive to understand.
# The following example shows code, that can be understood by thinking about it for one or two minutes,
# but it makes it much easier to understand with a simple comment.
#
# See line 47 in this file.
...
#
# See line 37 in this file.
#
# Side effect free functions:
# Side effect free functions are functions that do not affect the global state. 
# This is mostly possible, but not for database interactions or other input/output operations (for example UI).
# 
# See line 51 in this file.
...
# that is not overwritten by the fit_transform() function. Instead, the new variable 'tfidf_matrix' gets introduced.
...
# Clean Code:
# The following function has multiple lines of code, that are not easy to understand if you are new to this codebase.
# So it makes it much easier for other programmers if I put simple comments over each line, to save time and confusion later on.
 
# Functional Programming:
# The following function is a good example of the side-effect-free functions in this project.
